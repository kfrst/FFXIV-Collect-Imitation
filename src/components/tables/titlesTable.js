      ...
      <StyledTable>
        <StyledTable.Thead>
          <StyledTable.Tr>
            ...
            <StyledTable.Th sort={true} alignText={"default"} onClick={() => changeSort("title")}>
              Title
              {sortOrder && sortKey === "title" && (
                <StyledTable.Arrow sortOrder={sortOrder}></StyledTable.Arrow>
              )}
            </StyledTable.Th>
            <StyledTable.Th sort={true} alignText={"default"} onClick={() => changeSort("achievement")}>
              Achievement
              {sortOrder && sortKey === "achievement" && (
                <StyledTable.Arrow sortOrder={sortOrder}></StyledTable.Arrow>
              )}
            </StyledTable.Th>
          ...
          {sortedTableData().map((data) => {
            return (
              <StyledTable.Tr owned={data.isOwned} key={data.id}>
                <StyledTable.Td data-value={data.order} alignText="default" />
                <StyledTable.Td alignText={"default"}>
                  {data.femaleName !== data.title ? (
                    <>
                      {data.title}
                      <br />
                      {data.femaleName}
                ...
                <StyledTable.Td alignText={"default"}>
                  <StyledLink to={data.achievementPath}>{data.achievement}</StyledLink>
                </StyledTable.Td>
